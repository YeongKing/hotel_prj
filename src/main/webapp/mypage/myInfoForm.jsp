			...
			<div class="inner">
                ...
                <div class="myContents">
                        ...
                        <ul class="intList">
                            ...
                            <li class="intList-address">
                                ...
                                <div class="intBox">
                                    ...
                                    <span class="frm">
                                        <input type="radio" id="address-02" name="addressType" value="02"  ><label for="address-02"><!-- 회사 -->회사</label>
                                    </span>
                                </div>
                                <!-- //20200528 수정 : 주소옵션(추가) -->
                                <div class="intInner">
                    ...
                    <!-- //SNS 연동 로그인 -->
                     ...
                     <!-- 20200709 수정 : (SNS 연동 로그인 ↔ 약관 동의) 위치(변경) -->
                    <!-- 20200709 수정 : (마케팅동의 → 약관 동의) 문구(수정) -->
                    <!-- 약관 동의 -->
                    <h4 class="titDep3"><!-- 약관 동의 -->약관동의</h4>
                    <ul class="toggleList agreeCont"><!-- 20200720 수정 : (.toggleList.rsvList → .toggleList.agreeCont) 약관통합class(수정) -->
                        <!-- 20200720 수정 : 마케팅 약관 타이틀(변경)/내용(추가) -->
                        <li>
							<span class="frm type02">
								<input type="checkbox" id="frmChk01" name="mberAgreChk"  value="A0003"   ><label for="frmChk01"><!-- [선택] 마케팅 활용을 위한 개인정보 이용 동의 -->[선택] 마케팅 활용을 위한 개인정보 이용 동의</label>
							</span>
                            ...
                            <div class="toggleCont">
                                <div class="toggleInner">
                                   <div class="nonSrollWrap">
										<p class="notiTxt"><!-- 조선호텔앤리조트의 회원서비스 관련 정보, 할인상품 및 신상품 안내, 이벤트 및 맞춤 서비스 정보 수신을 위해 개인정보를 수집 및 이용하는 것에 동의 합니다. -->조선호텔앤리조트의 회원서비스 관련 정보, 할인상품 및 신상품 안내, 이벤트 및 맞춤 서비스 정보 수신을 위해 개인정보를 수집 및 이용하는 것에 동의 합니다.</p>
										<div class="frmWrap">
										  
										   
											 <span class="frm">
												 <input type="checkbox" id="frmChk04-1" name="mrkTyChk" value="01"   ><label for="frmChk04-1"><!-- SMS 수신동의 -->SMS 수신동의</label>
											 </span>
											 ...
											 <span class="frm">
												 <input type="checkbox" id="frmChk04-2" name=mrkTyChk value="02" ><label for="frmChk04-2"><!-- E-MAIL 수신동의 -->E-MAIL 수신동의</label>
											 </span>
											  ...
											  <span class="frm">
												<input type="checkbox" id="frmChk04-4" name="mrkTyChk" value="03" ><label for="frmChk04-4"><!-- 전화 수신동의 -->전화 수신동의</label>
											  </span>
											 ...
											 <span class="frm">
												<input type="checkbox" id="frmChk04-3" name="mrkTyChk" value="04" ><label for="frmChk04-3"><!-- 우편물 수신동의 -->우편물 수신동의</label>
											 </span>
										...
										<table class="tblH">
											<colgroup><col style="width:20%"><col style="width:34%" span="2"></colgroup>
											<caption><!-- 마케팅 활용을 위한 개인정보 이용 동의 -->마케팅 활용을 위한 개인정보 이용 동의</caption>
											<thead>
												<tr>
													<th scope="col"><!-- 수집 항목 -->수집 항목</th>
													<th scope="col"><!-- 수집 목적 -->수집 목적</th>
													<th scope="col"><!-- 보유 기간 -->보유 기간</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<th scope="row" rowspan="2"><!-- 휴대폰번호 -->휴대폰번호</th>
													<td class="f18"><!-- SMS 마케팅/홍보 -->SMS 마케팅/홍보</td>
													<td class="f18" rowspan="2"><!-- 회원탈퇴 또는 5년간 이용실적 없을 시 -->회원탈퇴 또는 5년간 이용실적 없을 시</td>
												</tr>
												<tr>
													<td class="f18 lineL"><!-- 전화 마케팅/홍보 -->전화 마케팅/홍보</td>
												</tr>
												<tr>
													<th scope="row"><!-- 이메일주소 -->이메일주소</th>
													<td class="f18"><!-- E-MAIL 마케팅/홍보 -->E-MAIL 마케팅/홍보</td>
													<td class="f18"><!-- 회원탈퇴 또는 5년간 이용실적 없을 시 -->회원탈퇴 또는 5년간 이용실적 없을 시</td>
												</tr>
												<tr>
													<th scope="row"><!-- 주소 -->주소</th>
													<td class="f18"><!-- 우편물 마케팅/홍보 -->우편물 마케팅/홍보</td>
													<td class="f18"><!-- 회원탈퇴 또는 5년간 이용실적 없을 시 -->회원탈퇴 또는 5년간 이용실적 없을 시</td>
												</tr>
											</tbody>
										</table>
										<p class="txtGuide"><!-- 위 개인정보 수집·이용에 대한 동의를 거부할 수 있으나 동의 거부 시 할인 및 이벤트 정보 안내 등의 서비스가 제한됩니다. -->위 개인정보 수집·이용에 대한 동의를 거부할 수 있으나 동의 거부 시 할인 및 이벤트 정보 안내 등의 서비스가 제한됩니다.</p>
									</div>
                                </div>
                            </div>
                        </li>                        
                    ...
                    <!-- //자녀 정보 입력 -->
                    <!-- 20200528 수정 : 문구/구성/class명(전체변경) -->
                    
                    <!-- 관심 정보 선택 -->
                    <h4 class="titDep3"><!-- 관심 정보 선택 -->관심 정보 선택</h4>
                    <!-- 20200528 수정 : UI변경(toggleList → frmList) -->
                    <div class="addItemArea">
                        <ul class="frmList type03">
                        
                            <li class="frmCheck"><input type="checkbox" id="frmChk1"  name="instrstChk" value="01"> <label for="frmChk1"><!-- 호텔패키지 -->호텔패키지</label></li>
                            <li class="frmCheck"><input type="checkbox" id="frmChk2"  name="instrstChk" value="02"><label for="frmChk2"><!-- 이벤트/프로모션 -->이벤트/프로모션</label></li>
                            <li class="frmCheck"><input type="checkbox" id="frmChk3"  name="instrstChk" value="03"><label for="frmChk3"><!-- 객실 -->객실</label></li>
                            <li class="frmCheck"><input type="checkbox" id="frmChk4"  name="instrstChk" value="04"><label for="frmChk4"><!-- 레스토랑 -->레스토랑</label></li>
                            <li class="frmCheck"><input type="checkbox" id="frmChk5"  name="instrstChk" value="05"><label for="frmChk5"><!-- 연회 -->연회</label></li>
                        
                        
                        
                        </ul>
                       <!--  <div class="side"><button type="button" class="btnLine"  onclick="fncIntrstInit();return false;">초기화</button></div> -->
                    </div>
                    <!-- //20200528 수정 : UI변경(toggleList → frmList) -->
                    <!-- //관심 정보 선택 -->
                    <div class="btnArea">
