...
<title>다이닝 예약 - 호텔, 다이닝 선택 | 엘리시안호텔</title>
...
<script type="text/javascript">
    ...
    function fncNotLoginResv(){
        $("#form").attr("action", "/user/resve/dining/step1.do");
    ...
    function fncLoginResv(){
        ...
        var nextUrl = "/user/resve/dining/step0.jsp?searchSysCode="+searchSysCode+"&diningCode="+diningCode ;

        jQuery("#nextURL").val(nextUrl);
        jQuery("#loginForm").attr("action", "/user/login/loginForm.jsp");
