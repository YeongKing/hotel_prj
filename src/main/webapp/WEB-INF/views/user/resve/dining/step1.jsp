			...
			<div id="container" class="container">
				...
				<div class="topArea">
					<div class="topInner">
						...
						<div class="stepWrap">
							<ol>
								<li class="on"><span class="hidden">현재단계</span><em>날짜,
										시간, 인원 선택</em></li>
								<!-- 날짜, 시간, 인원 선택 -->
								<li><em>예약정보 상세</em></li>
								<!-- 예약정보 상세 -->
				...
				<div class="inner">
					<div class="diningContainer drDining_st02">
						...
						<div class="selectInfoWrap" id="selectInfoWrap"
							style="display: none;">
							<p class="tit">예약 정보</p>
							<!-- 예약 정보 -->
							<div class="colorBox">
						...
						<div class="btnArea">
							<a href="javascript:void(0)" class="btnSC btnL"
								onclick="fncGoStep0();">이전</a>
							<!-- 이전 -->
							<a href="javascript:void(0)" class="btnSC btnL active"
								onclick="fncGoStep2();">다음</a>
							<!-- 다음 -->
						</div>
					</div>
				</div>
