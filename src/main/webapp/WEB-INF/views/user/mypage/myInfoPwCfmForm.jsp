...
<title>개인정보관리 - 회원 정보 수정, 비밀번호 입력 | 엘리시안호텔</title>
...
<script type="text/javascript">
    // 회원 정보 수정 진입 전 패스워드 재확인
	function fncMyInfoPwCfmApi() {
		...
		var formData =  $("#formMyInfoPwForm").serialize();
    ...
    function goConvertPage() {
    	$("#formMyInfoPwForm").attr("action", "myInfoForm.do");
	    $("#formMyInfoPwForm").attr("method", "post");
	    $("#formMyInfoPwForm").submit();
	} // goConvertPage
</script> 

<form id="formMyInfoPwForm">
...
<div class="inner">
	...
	<p class="pageGuide tleft">정보를 안전하게 보호하기 위해 비밀번호를 다시 한 번 확인합니다.</p>
		...
		<div class="btnArea">
			<button type="button" class="btnSC btnL" onclick="fncMyInfoPwCfmApi();">다음</button>
		</div>
	</div>
	<!-- myContents -->
