...
<html lang="ko">
 <head>
  ...
  <meta property="og:url" content="https://josunhotel.com/cnfirm/mber/room/reserveList.do">
  ...
  <link rel="canonical" href="https://josunhotel.com/cnfirm/mber/room/reserveList.do"/>
					...
					<div class="searchOp">
						...
						<div class="selectWrap" style="width:346px">
							<select title="조회옵션" data-height="150px" id="searchDataType" name="searchDataType">
										...
										<option value="GJB" selected="selected">그랜드 조선 부산</option>
