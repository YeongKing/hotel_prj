...
<html lang="ko">
 <head>
  ...
  <link href="http://localhost/hotel_prj/home/bluewaves/css/pc/contents.css" rel="stylesheet" type="text/css"> 
  <link href="http://localhost/hotel_prj/home/css/ko/pc/swiper.css" rel="stylesheet" type="text/css"> 
...
function fncSearchList(){
	...
	jQuery("#step0Form").attr("action", "/resve/room/step1.do");
