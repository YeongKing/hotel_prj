...
<html lang="ko">
 <head>
  ...
  <title>조선호텔앤리조트 공식 사이트 | JOSUN HOTELS &amp; RESORTS Official Website</title>
  ...
  <link rel="canonical" href="https://josunhotel.com/intro.do"/>
  ...
  <link href="http://localhost/hotel_prj/static/home/css/ko/pc/main_josunhotel.css" rel="stylesheet" type="text/css">
				...
				<div class="swipeWrapArea">
					...
					<div class="swipeWrap swipeGroup">
						<ul class="swipeCont">
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=2039698&sysCode=FPBSS" alt="신선하고 건강한 재료로 만든 아침 식사와 함께 든든한 하루를 시작해보세요!">
												<!-- 멤버십 전용 패키지인 경우 -->
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=2016243&sysCode=JOSUNHOTEL" alt="조선호텔앤리조트 Mindful Stay">
												<!-- 멤버십 전용 패키지인 경우 -->
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=2009718&sysCode=PPJ" alt="Stay 22 Hours with Chi-Mac">
												<!-- 멤버십 전용 패키지인 경우 -->
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1946318&sysCode=LESCAPE" alt="레스케이프 x 싱가포르항공 제휴">
												<!-- 멤버십 전용 패키지인 경우 -->
...
싱가포르항공 제휴 기념 특별 패키지를 소개합니다.</span>
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1921790&sysCode=GJB" alt="Spring Awakening">
												<!-- 멤버십 전용 패키지인 경우 -->
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1907379&sysCode=GRP" alt="Feel dynamic with GRAVITY">
												<!-- 멤버십 전용 패키지인 경우 -->
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1878306&sysCode=TWCB" alt="ROMANTIC MOMENT">
												<!-- 멤버십 전용 패키지인 경우 -->
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1869669&sysCode=TWCB" alt="SUNDAY MORNING PACKAGE ">
												<!-- 멤버십 전용 패키지인 경우 -->
...
객실안에서 편안하게 즐기는 아침을 마주하세요 
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1845720&sysCode=FPBSM" alt="WINE LOVES CHEESE">
												<!-- 멤버십 전용 패키지인 경우 -->
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1798453&sysCode=TWC" alt="In Room Dining- American Breakfast">
												<!-- 멤버십 전용 패키지인 경우 -->
...
인룸다이닝 미국식 조찬, 뷔페 레스토랑 아리아 조식이 준비 돼 있습니다. </span>
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1798106&sysCode=TWC" alt="Aria grill">
												<!-- 멤버십 전용 패키지인 경우 -->
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1772531&sysCode=TWCB" alt="1792 JOSUNCATION">
												<!-- 멤버십 전용 패키지인 경우 -->
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1666798&sysCode=FPBSS" alt="전통과 현대 맛과 멋이 가득한 서울을 시티버스를 타고 즐겨보세요!">
												<!-- 멤버십 전용 패키지인 경우 -->
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1481795&sysCode=GJB" alt="2 Nights Escape!">
												<!-- 멤버십 전용 패키지인 경우 -->
...
2박 투숙으로 달콤한 재충전의 시간을 가져보세요. </span>
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1946272&sysCode=LESCAPE" alt="레스케이프 맵탱">
												<!-- 멤버십 전용 패키지인 경우 -->
...
팔레드 신 쉐프가 새롭게 재해석한 &#039;맵탱&#039;을 만나보세요</span>
										...
										<li class="swipeSlide">
											<span class="thum">
												<img src="/util/file/download.do?fileSn=1645126&sysCode=TWC" alt="스파 썸네일">
												<!-- 멤버십 전용 패키지인 경우 -->
		...
		<div class="mainArea05">
			...
			<ul class="obBg">
				...
				<li class="bg05"><img src="/static/home/images/ko/pc/HUMA/bg_main03_05.jpg" alt="조선호텔 김치"></li>
				<li class="bg06"><img src="/static/home/images/ko/pc/HUMA/bg_main03_06.jpg" alt="Kyukmul Gongboo"></li>
				<li class="bg07"><img src="/static/home/images/ko/pc/HUMA/bg_main03_07.jpg" alt="Jane Packer"></li>
