 ...
 info="" %>
			...
			<div class="headArea">
				...
				<div class="topUtil">
                    ...
                    <a href="/hotel_prj/package/list.jsp" class="hotelFind" >상품찾기</a>
					<div class="langArea">
                ...
                <!-- 프로모션 배너 -->
                    ...
                    <div class="promotionBanner">
                        <a href="https://www.josunhotel.com/esgPromotion/main.do">
                            <img src="/hotel_prj/static/home/images/ko/pc/common/pc_img_promotion_banner.jpg" alt="">
                        </a>
                    </div>
						...
						<ul class="menuDepth01">
                                ...
                                <li  >HOTELS
										...
										<ul class="menuDepth02">
													...
													<li><a href="/hotel_prj/index.jsp">엘리시안 서울</a>
